...
class strcmp(FakeSimProcedure):
    ...
    def run(self, a_addr, b_addr, wchar=False, ignore_case=False):
        ...
        strncmp = self.inline_call(SIM_PROCEDURES['libc']['strncmp'], a_addr, b_addr, maxlen, a_len=a_strlen, b_len=b_strlen, wchar=wchar, ignore_case=ignore_case)
